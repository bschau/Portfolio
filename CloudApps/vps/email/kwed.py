...
def load_rss():
    ...
    rss = feedparser.parse('https://' + REMIX_HOST + '/rss.xml')
    if rss.bozo > 0:
        return all_music
...
def get_download_url(file_id):
    ...
    """
    connection = HTTPSConnection(REMIX_HOST)
    ...
    return 'https://' + REMIX_HOST + quote(location)
...
def main():
    ...
    feedparser.USER_AGENT = 'pykwed/1.4'
    music = load_rss()
